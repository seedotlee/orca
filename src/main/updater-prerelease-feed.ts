...
const ATOM_FEED_URL = `${MAIN_RELEASE_REPO_URL}/releases.atom`
const RELEASES_DOWNLOAD_BASE = `${MAIN_RELEASE_REPO_URL}/releases/download`
...
const TAG_HREF_RE = new RegExp(
  `href="${escapeRegex(`${MAIN_RELEASE_REPO_URL}/releases/tag/`)}([^"]+)"`,
  'g'
)
