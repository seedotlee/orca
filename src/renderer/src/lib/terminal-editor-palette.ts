...
export function resolveTerminalEditorPalette(
  ...
  return {
    ...
    syntax: {
      // Why: ANSI palettes have no dedicated muted color; mix like --muted-foreground so comments recede but stay legible.
      comment: mixHexColors(foreground, background, commentPercent),
